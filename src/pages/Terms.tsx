    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-950 to-blue-900">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="glass-panel p-8 max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-blue-100 mb-8">Terms of Service</h1>
          
          <div className="space-y-6 text-blue-200">
            <section>
              <h2 className="text-2xl font-semibold text-blue-100 mb-4">Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-blue-100 mb-4">Use License</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-blue-100 mb-4">User Responsibilities</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-blue-100 mb-4">Limitations</h2>
              <p>You may not:</p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-blue-100 mb-4">Disclaimer</h2>
